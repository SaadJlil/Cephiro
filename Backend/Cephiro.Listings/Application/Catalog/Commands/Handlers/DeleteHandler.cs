...
public sealed class DeleteListingHandler: IConsumer<DeleteListingRequest>
{
    ...
    private readonly IValidator<DeleteListingRequest> _validator; 

    public DeleteListingHandler(ICatalogExecute catalogRepository, IValidator<DeleteListingRequest> validator)
    {

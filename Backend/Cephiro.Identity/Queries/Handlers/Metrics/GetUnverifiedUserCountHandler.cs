...
public sealed class GetUnverifiedUserCountHandler: IConsumer<UnverifiedUserCountRequest>
{
    ...
    public async Task Consume(ConsumeContext<UnverifiedUserCountRequest> context)
    {
